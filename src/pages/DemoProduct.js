                        ...
                        <div className="w-full bg-white p-8 my-4 md:px-12 lg:w-9/12 lg:pl-20 lg:pr-40 mr-auto rounded-2xl shadow-2xl">
                            ...
                            <div className="flex items-center my-4">
                                <input 
                                 ...
                                 />
                                <label htmlFor="checkbox-1" className="ml-3 text-lg font-medium text-gray-900">Medibhai - Healthcare Partner</label>
                            </div>
                            <div className="flex items-center my-4">
                                <input 
                                    id="checkbox-1" 
                                    ...
                                    />
                                <label htmlFor="checkbox-1" className="ml-3 text-lg font-medium text-gray-900">HelpInsure</label>
                            </div>
                            <div className="flex items-center my-4">
                                <input 
                                    id="checkbox-1" 
                                ...
                                />
                                <label htmlFor="checkbox-1" className="ml-3 text-lg font-medium text-gray-900">Hyten.Ai</label>
                            </div>
                            <div className="flex items-center my-4">
                                <input 
                                    id="checkbox-1" 
                                ...
                                />
                                <label htmlFor="checkbox-1" className="ml-3 text-lg font-medium text-gray-900">EMedlife</label>
                            </div>
                            {errors && 
                        ...
                        <div className="flex flex-col text-white">     
                            <div className="flex my-4 w-2/3 lg:w-3/4">
                                ...
                                <div className="flex flex-col">
                                    ...
                                    <p className="text-gray-400">Unit No 1b 100, Phoenix Paragon Plaza Mall, Lbs Marg, Kamani Junction, Kurla W, Mumbai Suburban, Maharashtra, 400070</p>
                                </div>
                            </div>
                            ...
                            <div className="flex my-4 w-2/3 lg:w-1/2">
                                ...
                                <div className="flex flex-col">
                                    ...
                                    <p className="text-gray-400">Tel: +919967536662</p>
                                
                                    <div className='mt-5'>
                                        <h2 className="text-2xl">Send an E-mail</h2>
                                        <p className="text-gray-400">writetous@enirmaan.com</p>
                                    </div>
                            ...
                            <div className="flex my-4 w-2/3 lg:w-1/2">
                                <a href="hhttps://www.facebook.com/p/Medibhai-100076025236619/" target="_blank" rel="noreferrer" className="rounded-full flex justify-center bg-white h-8 text-blue-900  w-8 mx-1 text-center pt-1">
                                ...
                                <a href="https://www.linkedin.com/company/enirmaan-techsolutions-private-limited/" target="_blank" rel="noreferrer" className="rounded-full flex justify-center bg-white h-8 text-blue-900  w-8 mx-1 text-center pt-1">
